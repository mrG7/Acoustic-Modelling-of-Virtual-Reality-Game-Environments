...
#ifndef AMVRGEFXParams_H
#define AMVRGEFXParams_H
...
struct AMVRGERTPCParams
{
    AkReal32 fDummy;
};

struct AMVRGENonRTPCParams
{
};

struct AMVRGEFXParams
    : public AK::IAkPluginParam
{
    AMVRGEFXParams();
    AMVRGEFXParams(const AMVRGEFXParams& in_rParams);
    ...
    AMVRGERTPCParams RTPC;
    AMVRGENonRTPCParams NonRTPC;
} AK_ALIGN_DMA;

#endif // AMVRGEFXParams_H
